...
void getStudents (University& unit) {
    List <Student> result = unit.getStudentsWithout3();
    if (result.length() == 0) {
        std::cout << "Students has no found" << std::endl;
    }
    std::cout << "Students without 3:" << std::endl;
...
int main () {
    ...
    std::cout << 
        ...
        "3. Get Students Without 3" << std::endl << 
